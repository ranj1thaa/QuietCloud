...
function Register() {
  const {createNewUser,googleUser, loading, setLoading}=useAppContext()
  ...
  return (
    <div style={{display: 'flex', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', flexDirection: 'column', width: '100%', backdropFilter: 'blur(4px)'}}>
      ...
      <Form style={{width: '90%', maxWidth: '800px', padding: '20px',borderRadius: '8px',boxShadow: '2px 2px 8px rgba(0,0,0,0.3)',textAlign: 'center'}} onSubmit={handleRegisterUser}>
